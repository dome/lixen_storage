...
Ext.extend(OMV.Module.Information.About, Ext.Panel, {
	initComponent : function() {
		...
		// Copyright
		this.html += this.createBox("Lixen Storage is Copyright © 2012 by Linuxen Co.,Ltd. (info@lixen.net).<br/>" +
		  "All rights reserved.<br/><br/>" +
		  "Lixen Storage is free software: you can redistribute it and/or modify " +
		  "it under the terms of the GNU General Public License v3 as published by " +
		  "the Free Software Foundation.<br/><br/>" +
		  "Lixen Storage is distributed in the hope that it will be useful, " +
		  "but WITHOUT ANY WARRANTY; without even the implied warranty of " +
		  "MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the " +
		  "GNU General Public License for more details.<br/><br/>" +
		  "You should have received a copy of the GNU General Public License " +
		  "along with Lixen Storage. If not, see &lt;<a href='http://www.gnu.org/licenses' " +
	...
	renderSoftware : function() {
		...
		return "Lixen Storage is based upon various free software " +
